export const types = [
    ...
    },
    {
        ...
        category: "account",
        definition: 'export type HostProductDeviceChatRequest =\n  | { tag: "Bind"; value: { productAccountId: ProductAccountId; peerIdentityAccountId: HexString; peerChatPublicKey: HexString } }\n  | { tag: "Seal"; value: { productAccountId: ProductAccountId; peerChatPublicKey: HexString; plaintext: HexString } }\n  | { tag: "Open"; value: { productAccountId: ProductAccountId; peerChatPublicKey: HexString; combinedCiphertext: HexString } }\n;',
        ...
        variants: [
            ...
            {
                name: "Seal",
                type: '{ tag: "Seal"; value: { productAccountId: ProductAccountId; peerChatPublicKey: HexString; plaintext: HexString } }',
                description: "Seal identity-route plaintext for the peer with a host-generated nonce.",
            },
            {
                name: "Open",
                type: '{ tag: "Open"; value: { productAccountId: ProductAccountId; peerChatPublicKey: HexString; combinedCiphertext: HexString } }',
