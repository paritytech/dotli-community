export const types = [
    ...
    },
    {
        ...
        category: "transaction",
        definition: "export interface HostCreateTransactionRequest {\n  productAccountId: ProductAccountId;\n  payload: VersionedTxPayload;\n}",
        fields: [
            {
                name: "product_account_id",
                type: "ProductAccountId",
    ...
    },
    {
        ...
        category: "signing",
        definition: "export interface HostCreateTransactionWithLegacyAccountRequest {\n  payload: VersionedTxPayload;\n}",
        fields: [
            {
                name: "payload",
                type: "VersionedTxPayload",
    ...
    },
    {
        ...
        description: "Outcome of a remote-permission batch request. The decision applies to the\nwhole batch.",
        fields: [
            {
                name: "granted",
                type: "boolean",
    ...
    },
    {
        ...
        category: "transaction",
        definition: "export interface TxPayloadContextV1 {\n  metadata: HexString;\n  tokenSymbol: string;\n  tokenDecimals: number;\n  bestBlockHeight: number;\n}",
        fields: [
            {
                name: "metadata",
                type: "HexString",
    ...
    },
    {
        ...
        category: "transaction",
        definition: "export interface TxPayloadExtensionV1 {\n  id: string;\n  extra: HexString;\n  additionalSigned: HexString;\n}",
        fields: [
            {
                name: "id",
                type: "string",
