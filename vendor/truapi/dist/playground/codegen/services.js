    ...
    },
    {
        ...
        methods: [
            ...
            },
            {
                name: "retract",
                type: "unary",
                signature: "retract(): Promise<Result<undefined, S.CallErrorValue<VersionedHostProfileRetractError>>>",
                docUrl: "api/profile/trait.Profile.html#method.retract",
                description: "Withdraw the reference this product disclosed. Contacts are told to\ndrop what they hold. A product that did not disclose it is refused.",
                exampleSource: 'const result = await truapi.profile.retract();\nconsole.log("profile retracted:", result);',
            },
            {
                name: "present_contact",
                type: "unary",
                signature: "presentContact(request: HostProfilePresentContactRequest): Promise<Result<undefined, S.CallErrorValue<VersionedHostProfilePresentContactError>>>",
                docUrl: "api/profile/trait.Profile.html#method.present_contact",
                description: "Show a chat contact's profile in host-owned UI.\n\nThe product names the contact; the host looks up the reference that\ncontact shared and presents it as `present` would. The reference never\nreaches the product. A contact who shared nothing is `NotShared`.",
                requestDescription: "HostProfilePresentContactRequest",
