 ...
 */
export const DEV_ACCOUNT_NAMES = Object.keys(DEV_ACCOUNTS);
/** Whether `name` is one of the built-in dev accounts. */
export function isDevAccountName(name) {
 ...
 */
export function resolveAccount(spec) {
 ...
 * ```
 */
export function liveChain(chain) {
