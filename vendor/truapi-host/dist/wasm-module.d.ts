...
export interface WorkerProductRuntime {
     ...
     */
    render(request: Uint8Array, onUpdate: (node: Uint8Array) => void, onComplete: () => void, onError: (reason: string) => void): WorkerRendererSubscription;
}
...
export interface WasmModuleShape {
     ...
     */
    deriveProductAccountPublicKey: (productSubtreePublicKey: Uint8Array, derivationIndex: Uint8Array) => Uint8Array;
