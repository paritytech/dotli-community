...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_15642: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_15644: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4503: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_4504: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_9678: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_4505: (a: number, b: number) => void;
