...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_16965: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_16968: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3508: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3505: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_10978: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_3507: (a: number, b: number) => void;
