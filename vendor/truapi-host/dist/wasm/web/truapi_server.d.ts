...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_16520: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_16523: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3436: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3434: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_10558: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_3433: (a: number, b: number) => void;
