...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_16712: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_16715: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3490: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3487: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_10739: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_3489: (a: number, b: number) => void;
