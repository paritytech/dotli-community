...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_17232: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4865: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_4866: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_11143: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_4867: (a: number, b: number) => void;
