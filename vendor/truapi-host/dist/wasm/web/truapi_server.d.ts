...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_16931: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_16934: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3504: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3501: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3503: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_11014: (a: number, b: number) => void;
