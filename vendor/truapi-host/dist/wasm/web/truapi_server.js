...
export class WasmPairingHostRuntime {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmPairingHostRuntimeFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
    ...
    activateExternalSession(blob) {
        ...
        const ret = wasm.wasmpairinghostruntime_activateExternalSession(this.__wbg_ptr, ptr0, len0);
    ...
    activateStoredSession() {
        const ret = wasm.wasmpairinghostruntime_activateStoredSession(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     ...
     */
    cancelPairing() {
        wasm.wasmpairinghostruntime_cancelPairing(this.__wbg_ptr);
    }
    /**
    ...
    clearProductState(product_id) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpairinghostruntime_clearProductState(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
     ...
     */
    deviceEncryptionKey() {
        const ret = wasm.wasmpairinghostruntime_deviceEncryptionKey(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     ...
     */
    disconnectSession() {
        const ret = wasm.wasmpairinghostruntime_disconnectSession(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
    ...
    constructor(callbacks, host_config) {
        try {
            ...
            wasm.wasmpairinghostruntime_new(retptr, addHeapObject(callbacks), addHeapObject(host_config));
            ...
            this.__wbg_ptr = r0;
            WasmPairingHostRuntimeFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
    ...
    notifySessionStoreChanged() {
        wasm.wasmpairinghostruntime_notifySessionStoreChanged(this.__wbg_ptr);
    }
    /**
    ...
    permissionAuthorizationStatus(product_id, payload) {
        ...
        const ret = wasm.wasmpairinghostruntime_permissionAuthorizationStatus(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return takeObject(ret);
    }
    /**
    ...
    permissionAuthorizationStatuses(product_id, payloads) {
        const ptr0 = passStringToWasm0(product_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpairinghostruntime_permissionAuthorizationStatuses(this.__wbg_ptr, ptr0, len0, addHeapObject(payloads));
        return takeObject(ret);
    }
    /**
     ...
     */
    resetSessionState() {
        const ret = wasm.wasmpairinghostruntime_resetSessionState(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
    ...
    sessionChatIdentityKey() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wasmpairinghostruntime_sessionChatIdentityKey(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            let v1;
            if (r0 !== 0) {
    ...
    setPermissionAuthorizationStatus(product_id, payload, status) {
        ...
        const ret = wasm.wasmpairinghostruntime_setPermissionAuthorizationStatus(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
        return takeObject(ret);
    }
}
if (Symbol.dispose) WasmPairingHostRuntime.prototype[Symbol.dispose] = WasmPairingHostRuntime.prototype.free;
...
export class WasmProductRuntime {
    static __wrap(ptr) {
        const obj = Object.create(WasmProductRuntime.prototype);
        obj.__wbg_ptr = ptr;
        WasmProductRuntimeFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmProductRuntimeFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
     ...
     */
    disconnectSession() {
        const ret = wasm.wasmproductruntime_disconnectSession(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
    ...
    dispose() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wasmproductruntime_dispose(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    constructor(callbacks, runtime_config) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wasmproductruntime_new(retptr, addHeapObject(callbacks), addHeapObject(runtime_config));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
            ...
            this.__wbg_ptr = r0;
            WasmProductRuntimeFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
     ...
     * @returns {Promise<any>}
     */
    permissionAuthorizationStatus(payload) {
        const ptr0 = passArray8ToWasm0(payload, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmproductruntime_permissionAuthorizationStatus(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
     ...
     * @returns {Promise<Array<any>>}
     */
    permissionAuthorizationStatuses(payloads) {
        const ret = wasm.wasmproductruntime_permissionAuthorizationStatuses(this.__wbg_ptr, addHeapObject(payloads));
        return takeObject(ret);
    }
    /**
    ...
    publishChatAction(action) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(action, wasm.__wbindgen_export);
            const len0 = WASM_VECTOR_LEN;
            wasm.wasmproductruntime_publishChatAction(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    receiveFrame(frame) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmproductruntime_receiveFrame(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
     ...
     * @returns {Promise<void>}
     */
    setPermissionAuthorizationStatus(payload, status) {
        const ptr0 = passArray8ToWasm0(payload, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(status, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmproductruntime_setPermissionAuthorizationStatus(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return takeObject(ret);
    }
}
...
export class WasmSigningHostRuntime {
     ...
     * @returns {Uint8Array}
     */
    localIdentityAuthProof(activation_id, challenge) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(activation_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passArray8ToWasm0(challenge, wasm.__wbindgen_export);
            const len1 = WASM_VECTOR_LEN;
            wasm.wasmsigninghostruntime_localIdentityAuthProof(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
    ...
    localIdentityContext() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wasmsigninghostruntime_localIdentityContext(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
     ...
     */
    localLiteRegistrationBody(activation_id, username_base, verifier) {
        const ptr0 = passStringToWasm0(activation_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(username_base, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(verifier, wasm.__wbindgen_export);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.wasmsigninghostruntime_localLiteRegistrationBody(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
        return takeObject(ret);
    }
    /**
     ...
     * @returns {Promise<any>}
     */
    refreshLocalIdentity(activation_id) {
        const ptr0 = passStringToWasm0(activation_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
 ...
 * @param {Uint8Array} product_subtree_public_key
 * @param {Uint8Array} derivation_index
 * @returns {Uint8Array}
 */
export function deriveProductAccountPublicKey(product_subtree_public_key, derivation_index) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(product_subtree_public_key, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(derivation_index, wasm.__wbindgen_export);
        const len1 = WASM_VECTOR_LEN;
        wasm.deriveProductAccountPublicKey(retptr, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
 ...
 * @returns {any}
 */
export function describeCoreStorageKey(encoded) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(encoded, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        wasm.describeCoreStorageKey(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
 ...
 * @returns {string}
 */
export function productAccountAddress(public_key) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.productAccountAddress(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
 ...
 * @returns {string}
 */
export function wireSchemaHash() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wireSchemaHash(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_1824d93f294193e5: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return __wasm_bindgen_func_elem_16523(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 20, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_3436);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 2142, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_16520);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 1745, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_10558);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000004: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 18, ret: Unit, inner_ret: Some(Unit) }, mutable: false }) -> Externref`.
            const ret = makeClosure(arg0, arg1, __wasm_bindgen_func_elem_3433);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000005: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 19, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: false }) -> Externref`.
            const ret = makeClosure(arg0, arg1, __wasm_bindgen_func_elem_3434);
            return addHeapObject(ret);
        },
...
function __wasm_bindgen_func_elem_10558(arg0, arg1) {
    wasm.__wasm_bindgen_func_elem_10558(arg0, arg1);
}

function __wasm_bindgen_func_elem_3433(arg0, arg1) {
    wasm.__wasm_bindgen_func_elem_3433(arg0, arg1);
}

function __wasm_bindgen_func_elem_3436(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_3436(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_3434(arg0, arg1) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.__wasm_bindgen_func_elem_3434(retptr, arg0, arg1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
...
function __wasm_bindgen_func_elem_16520(arg0, arg1, arg2) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.__wasm_bindgen_func_elem_16520(retptr, arg0, arg1, addHeapObject(arg2));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
...
function __wasm_bindgen_func_elem_16523(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_16523(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
