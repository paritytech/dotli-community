import type { CustomRendererNode, HostChatActionSubscribeItem, WireProvider } from "@parity/truapi";
...
export interface TrUApiProductProvider extends WireProvider, CoreAdmin {
     ...
     * Present only on runtimes that keep a live channel to the core.
     */
    renderCustomMessage?(request: CustomMessageRenderRequest, sink: CustomMessageRenderSink): () => void;
}
